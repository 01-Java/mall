		...
		>
			<template #default="scope">
				<div class="category_node">
					<div>
						<el-image v-show="scope.data.level == 3" :src="scope.data.iconUrl" class="category_node_img">
							<template #error>
					...
					<div>
						<el-button v-show="scope.data.level != 3" type="success" link @click.stop="handleAdd(scope.data)"
							>新增</el-button
						>
						<el-button v-show="scope.data.id !== 0" type="warning" link @click.stop="handleUpdate(scope.data)"
							>编辑
						</el-button>
						<el-button
