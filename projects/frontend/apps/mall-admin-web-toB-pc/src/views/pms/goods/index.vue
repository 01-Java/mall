...
const { loading, ids, queryParams, goodsList, categoryOptions, goodDetail, total, dialogVisible } = toRefs(state);
		...
		<el-card>
			...
			>
				...
				<el-table-column label="操作" width="200">
					<template #default="scope">
						<el-button type="success" link @click.stop="handleGoodsView(scope.row.detail)">查看详情</el-button>
