	...
	<div class="app-container">
		...
		<el-form ref="queryFormRef" :model="queryParams" :inline="true">
			<el-form-item>
				...
				<el-button type="danger" click="handleDelete" :disabled="multiple"><i-ep-delete /> 删除</el-button>
			</el-form-item>
		...
		<el-table v-loading="loading" :data="brandList" border @selection-change="handleSelectionChange">
			...
			<el-table-column prop="logoUrl" label="LOGO" min-width="150">
				<template #default="scope">
					<el-popover placement="right" :width="400" trigger="hover">
						...
						<template #reference>
							<img :src="scope.row.logoUrl" style="max-width: 60px; max-height: 60px" />
						</template>
					</el-popover>
				</template>
			</el-table-column>
			...
			<el-table-column label="操作" width="200">
				<template #default="scope">
					<el-button type="primary" circle plain @click="handleUpdate(scope.row)"> <i-ep-edit /></el-button>
					<el-button type="danger" circle plain @click="handleDelete(scope.row)"> <i-ep-delete /></el-button>
				</template>
			</el-table-column>
		</el-table>
