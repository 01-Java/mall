      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="cartStore.isAll" @change="(val: boolean | string | number) => handleAllCheck(!!val)" />
              </th>
          ...
          <tbody>
            <tr v-for="item in cartStore.cartList" :key="item.id">
              <td>
                <el-checkbox :model-value="item.selected" @change="(val: boolean | string | number) => handleCheck(item.skuId, !!val)" />
              </td>
              <td>
                <div class="goods">
