...
const getLikeList = async () => {
  try {
    const res = await getLikeListAPI({ limit: 4 }) as unknown as ApiResponse;
    likeList.value = res.result;
  } catch (error) {
    console.error('获取猜你喜欢商品数据失败', error);
  }
};
...
<template>
  <div class="home-overview">
    ...
    <div class="user-meta">
      ...
      <h4>{{ userStore.profile.nickname || userStore.profile.account }}</h4>
    </div>
    <div class="item">
      <a href="javascript:;">
